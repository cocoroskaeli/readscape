...
export default function Home() {
  ...
  const { query } = useOutletContext<OutletContext>(); // ⬅️ прима query од App
    ...
    >
      {loadingSearch ? (
        ...
        <div ref={categoriesRef}>
          <CategoryRow title="Trending Books" books={trending} loading={loadingSections} itemsPerPage={5} />
          <CategoryRow title="Classic Books" books={classics} loading={loadingSections} itemsPerPage={5} />
          <CategoryRow title="Romance" books={romance} loading={loadingSections} itemsPerPage={5} />
          <CategoryRow title="Kids" books={kids} loading={loadingSections} itemsPerPage={5} />
          <CategoryRow title="Thrillers" books={thrillers} loading={loadingSections} itemsPerPage={5} />
          <CategoryRow title="Textbooks" books={textbooks} loading={loadingSections} itemsPerPage={5} />
        </div>
      )}
    </div>
  );
